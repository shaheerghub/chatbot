training_data = [
    ...
    {"text": "get user 85", "intent": "get_user"},
    {"text": "show user 85 details", "intent": "get_user"},
    {"text": "retrieve user 123 info", "intent": "get_user"},
    {"text": "find user 46", "intent": "get_user"},
    ...
    {"text": "todays purchases", "intent": "total_purchase"},
    ...
    {"text": "cancelled requests today", "intent": "cancelled_purchase"},
    {"text": "cancelled requests", "intent": "cancelled_purchase"},
    ...
    {"text": "2026D22755", "intent": "get_request"},
    {"text": "NM/PLEX(T)/003", "intent": "get_request"},
    {"text": "NM/AIMRI/012", "intent": "get_request"},
